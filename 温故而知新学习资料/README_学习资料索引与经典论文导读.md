# 足球博彩赔率精算与赛事预测 · 学术文献资料库（MarkItDown 纯净转译版）

> **目录位置**：`D:\100-工作\200-交易\足球预测\温故而知新学习资料\`  
> **更新时间**：2026-09-06  
> **学术定位**：本资料库收录全部 12 篇国际顶刊经过实证检验的真神级足球博彩与预测文献，剔除所有无关灌水杂质。全量文献与 `AGENTS.md` 8层推演模型及 `分析复盘记录/` 实盘战报形成强互联拓扑网络。

---

## 一、 十二篇核心学术文献全景谱系图与交叉拓扑网络
...
| 4 | **2008 顶刊** | 应用经济学 (2008) | 《博彩市场中的散户情绪偏见与庄家西甲定价偏见》 | 关联 [2604 冷门偏差](./2604.17194_Forecast_Sports_Outcomes_under_EMH_Odds_Only_Models.md) 与 [今日西甲战报](../分析复盘记录/2026-09-06_周日体彩平局精算分析与复盘档案.md) | [2008 全文](./2008_Sentiment_and_Bookmaker_Pricing_Bias.md) |
...
| 7 | **2019 Nature** | 自然子刊 (2019) | 《PlayeRank: 足球运动员单兵表现微观多维量化评估开源框架》 | 关联 [2025 深度学习](./2025_Success_Score_Deep_Learning_Football_Prediction.md) 与 [API-Sports微观数据](../AGENTS.md) | [2019 Nature](./2019_Nature_PlayeRank_Data_Driven_Framework.md) |
| 8 | **2025 Springer** | 人工智能进展 (2025) | 《粗暴战术犯规与平局概率联合预测贝叶斯网络分类器》 | 关联 [2017 平局难题](./2017_Problem_of_Correctly_Predicting_Draws_Soccer.md) 与 [今日帕尔马保级战报](../分析复盘记录/2026-09-06_周日体彩平局精算分析与复盘档案.md) | [2025 平局与犯规](./2025_Springer_Predicting_Draws_and_Fouls_Bayesian.md) |
...
| 13 | **Shin & Štrumbelj**| 算法专卷 (2026) | 《Shin 破译内幕黑幕博弈模型与 Štrumbelj 工业级反向去水工具箱》 | 关联 [2604 纯赔率模型](./2604.17194_Forecast_Sports_Outcomes_under_EMH_Odds_Only_Models.md) 与 [1802 泊松去水](./1802.08848_Combining_Historical_Data_and_Bookmakers_Odds.md) | [Shin算法精要](./Shin_1993_and_Strumbelj_2014_庄家赔率反向破译算法精要.md) |
...
1. **反向赔率破译门派**：
   * [Shin 算法精要](./Shin_1993_and_Strumbelj_2014_庄家赔率反向破译算法精要.md) 与 [2604.17194 纯赔率模型](./2604.17194_Forecast_Sports_Outcomes_under_EMH_Odds_Only_Models.md) 共同构成了剥离庄家内幕溢价 $z$ 与冷门偏见（FL-Bias）的数学底层；
   * [1710.02824 用庄家数据击败庄家](./1710.02824_Beating_the_Bookies_with_Their_Own_Numbers.md) 与 [2018 BORS 评级](./2018_PLOS_Betting_Odds_Rating_System_BORS.md) 形成了直接利用赔率预测赛果的实践闭环。
2. **平局发生物理机制门派**：
   * [2025 Springer 粗暴犯规与平局预测](./2025_Springer_Predicting_Draws_and_Fouls_Bayesian.md) 与 [2017 平局预测难题](./2017_Problem_of_Correctly_Predicting_Draws_Soccer.md) 揭示了平局的物理成因：战术绞杀、节奏切碎与能量耗散；
   * [1802.08848 贝叶斯泊松联合模型](./1802.08848_Combining_Historical_Data_and_Bookmakers_Odds.md) 提供了 0:0 与 1:1 比分发生的精确数学算式。
3. **球员微观单兵攻防门派**：
   * [2019 Nature PlayeRank 框架](./2019_Nature_PlayeRank_Data_Driven_Framework.md) 与 [2025 Success Score 深度架构](./2025_Success_Score_Deep_Learning_Football_Prediction.md) 将模型颗粒度由粗糙的“球队名字”细化至每位球员的对抗胜率、扑救率与绝佳机会转化率。
