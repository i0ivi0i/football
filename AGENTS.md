...
4. 🔄 **Karpathy 飞轮自动自我进化引擎（驱动胜率自我进化逼近 100%）**：
   ...
   * **4. 赛前盲区审计 (Post-Mortem)**：严禁赛中叙事，100% 审计哨响前已知数据盲区；警惕防御过度，严禁将偶发个案机械升级为刚性一票否决，重在修正分层条件矩阵而非盲目杀平；
...
3. **乔布斯极简产品思维与灵活智慧复盘铁律（拒死板绝僵化·自包含芯片规范）**：
   * **拒死板与防御过度**：严禁因单场偶发失误给全系统堆砌机械“一票否决”枷锁，彻底杜绝严刑峻法误杀优质平局；复盘重在洞察本质因果与动态场景分层，而非盲目罗列负向禁令；
   * **抓本质与自包含芯片**：永久杜绝具体单日日期、场次代号、具体球队或外链，所有经验必须 100% 抽象升华为【盘口量化特征 + 庄家收割刀法 + 动态条件落点】；以乔布斯极简主义追求高胜率与高优雅度；
