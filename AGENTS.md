...
1. 🚫 **红线 1（拒绝倾斜深盘）**：只要主胜或客胜有一方赔率 **$< 1.60$**，无论 0球赔率多低（严禁给 0球低赔开后门），一票否决，绝不单挑平局（彻底杜绝 012 弗鲁米嫩塞类失误）。
2. 🎭 **红线 2（辨别伪降水）**：客队水位显著低于主队时（如客 2.40 vs 主 2.76），平赔突发下降视为“诱平掩护客胜”，严禁看平（彻底杜绝乌迪内斯类诱平误读）。
3. 🪤 **红线 3（豪门高平阻盘防守反差硬雷达）**：高平阻盘（平赔 $\ge 3.60$）仅适用于**客队单季场均失球 $\le 0.8$ 的顶级铁桶队**；防守漏风的普通客队（失球 $> 1.0$）严禁滥套高平阻盘模型（彻底杜绝 006 斯旺西类失误）。
4. 🔒 **红线 4（势均力敌必须小球前置）**：水差 $< 0.25$ 的均势盘，**必须强制核验大小球赔率**；若 Over 2.5 赔率 **$< 1.75$**，直接判定为大球决胜负对攻局，一票否决单挑平局（彻底杜绝 003 布鲁日类失误）。
5. 🧱 **红线 5（大比分对攻平局雷达）**：对于荷甲、德乙等大球联赛，0球赔率超高（$\ge 25.00$）且平赔 $\ge 4.20$ 的对攻局，必须防范 2:2 / 3:3 大比分对攻平局收割。
