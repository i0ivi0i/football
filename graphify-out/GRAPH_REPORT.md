...
## Corpus Check
- 45 files · ~1,328,303 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 1 file(s) not represented in the graph (top: (none) 1)

## Summary
- 421 nodes · 657 edges · 35 communities (24 shown, 11 thin omitted)
- Extraction: 77% EXTRACTED · 8% INFERRED · 15% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0fc62952`
...
2. `足球概率分析现行规程` - 44 edges
3. `智慧经验与习惯塑形` - 34 edges
...
Cohesion: 0.05
Nodes (42): **ABSTRACT**, **ADDITIONAL FILES**, **AUTHOR AFFILIATIONS**, **AUTHOR CONTRIBUTIONS**, **AUTHOR INFORMATION**, **BACKGROUND**, Broader Importance of Outcome Bias, **CHOSEN STUDY FOR REPLICATION: BARON AND HERSHEY (1988)** (+34 more)
...
## Knowledge Gaps
- **239 isolated node(s):** `1. 【周日003 塞尔塔 1:1 马拉加】（平赔 3.50）`, `2. 【周日006 海伦芬 0:0 特尔斯达】（平赔 4.55，冷门白卷）`, `3. 【周日012 勒芒 2:2 朗斯】（平赔 4.15，对攻大冷平）`, `4. 【周日022 法马利康 1:1 里斯本竞技】（平赔 4.30，豪门爆冷）`, `一、 为什么【周日001 东京绿茵 1:1 千叶市原】被核心主推遗漏？` (+234 more)
...
- **What is the exact relationship between `历史待核查：2026-09-11_预测.md` and `历史待核查：2026-09-11 Post-Match Review`?**
  _Edge tagged AMBIGUOUS (relation: legacy_unverified_relation) - confidence is low._
- **What is the exact relationship between `已取代：项目规则与数据口径审计` and `智慧复盘论文索引`?**
  _Edge tagged AMBIGUOUS (relation: legacy_unverified_relation) - confidence is low._
- **What is the exact relationship between `已取代：项目规则与数据口径审计` and `智慧经验与习惯塑形`?**
  _Edge tagged AMBIGUOUS (relation: legacy_unverified_relation) - confidence is low._
- **What is the exact relationship between `已取代：项目规则与数据口径审计` and `足球概率分析系统手册`?**
  _Edge tagged AMBIGUOUS (relation: legacy_unverified_relation) - confidence is low._
- **What is the exact relationship between `已取代：项目规则与数据口径审计` and `预测记录与智慧复盘契约`?**
  _Edge tagged AMBIGUOUS (relation: legacy_unverified_relation) - confidence is low._
