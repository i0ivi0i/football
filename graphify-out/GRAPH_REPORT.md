...
## Corpus Check
- 53 files · ~158,590 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 269 nodes · 782 edges · 16 communities (14 shown, 2 thin omitted)
- Extraction: 65% EXTRACTED · 35% INFERRED · 0% AMBIGUOUS · INFERRED: 275 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d988e7bc`
...
- `test_赔率数值验证与去水计算()` --validates_capa1_probability_computation--> `8-Capas Betting Deduction Model`  [INFERRED]
  脚本/测试/test_领域模型.py → AGENTS.md
- `test_赔率数值验证与去水计算()` --tests_shin_devigging_logic--> `Shin Insider Trading Odds Inversion Model`  [INFERRED]
  脚本/测试/test_领域模型.py → 温故而知新学习资料/Shin_1993_and_Strumbelj_2014_庄家赔率反向破译算法精要.md
...
### Community 3 - "General Post-Mortem Manual & Blind-Spot Audit"
Cohesion: 0.16
Nodes (21): Karpathy Skill Self-Evolution Flywheel, 2026-09-06 Post-Match Review, 2026-09-07 Post-Match Review, 2026-09-08 Post-Match Review, 2026-09-10 Post-Match Review, 2026-09-11 Post-Match Review, Overall Accuracy & Real-time Scoreboard, General Post-Mortem Manual & Blind-Spot Audit (+13 more)

### Community 4 - "微观球员适配器"
Cohesion: 0.11
Nodes (20): Passing Network Centrality, PlayeRank Framework, Wyscout Spatio-Temporal Match Events Dataset, Any, Dynamic Seasonal Team Attack and Defence Effects, 2. 【周五011 塞维利亚 1:0 巴伦西亚】—— 进球前置锁正确但终结能力严重失衡, Match Outcome Classification via Thresholds, Success Score Metric (+12 more)
...
### Community 6 - "8-Capas Betting Deduction Model"
Cohesion: 0.07
Nodes (46): Consensus Odds-Based Betting Strategy, Bookmaker Account Limiting / Discriminatory Practices, Bookmakers' Consensus Probability, Paper Trading Validation, Clustered Probit Model, DIFFATTEND Proxy, Sentiment Bias in Betting Odds, ELO-Result Rating System (+38 more)
...
### Community 8 - "体彩官方适配器"
Cohesion: 0.25
Nodes (7): solve_shin_probabilities Solver, test_体彩官方适配器在基础胜平负关闭时自动捕获让球明牌(), test_体彩官方适配器安全过滤无赔率异常赛事(), test_体彩官方适配器解析原始数据为纯净领域快照(), 赔率快照, 实现赔率提供者契约，直连国家体彩中心官方网关, 体彩官方适配器

### Community 9 - "Five Hard Red Lines (V3.1 Physical Circuit Breakers)"
Cohesion: 0.12
Nodes (43): ELO-Goals Rating System, ELO-Odds Rating System, Informational Loss Metric, Five Hard Red Lines (V3.1 Physical Circuit Breakers), Asian Handicap (AH) Betting Market, Constantinou Hybrid Bayesian Network Model, Egidi Hierarchical Bayesian Poisson Model, Elo Rating Difference (+35 more)
...
- **Why does `8-Capas Betting Deduction Model` connect `8-Capas Betting Deduction Model` to `赔率数值`, `赔率快照`, `General Post-Mortem Manual & Blind-Spot Audit`, `微观球员适配器`, `Football Quant Agent Brain`, `体彩官方适配器`, `Five Hard Red Lines (V3.1 Physical Circuit Breakers)`?**
  _High betweenness centrality (0.270) - this node is a cross-community bridge._
- **Why does `Football Quant Agent Brain` connect `Football Quant Agent Brain` to `赔率数值`, `赔率快照`, `General Post-Mortem Manual & Blind-Spot Audit`, `微观球员适配器`, `心电图录像机.py`, `8-Capas Betting Deduction Model`, `体彩官方适配器`, `Five Hard Red Lines (V3.1 Physical Circuit Breakers)`, `本地账本仓储`, `Q: 周一001卡利亚里1:0与周一006乌迪内斯1:2失手复盘与赛前盲区审计`, `Q: 系统规范README与智慧大脑AGENTS协同架构`, `query_20260909_022637_7cd78681_2026_09_08_赛后复盘与模型3_1硬红线升级.md`, `Q: 体彩官方数据管道与API-Sports微观数据管道在赛前推演中的协同机制`?**
  _High betweenness centrality (0.243) - this node is a cross-community bridge._
- **Why does `赔率快照` connect `赔率快照` to `赔率数值`, `心电图录像机.py`, `8-Capas Betting Deduction Model`, `Football Quant Agent Brain`, `体彩官方适配器`, `本地账本仓储`?**
