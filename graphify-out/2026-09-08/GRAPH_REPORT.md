...
## Summary
- 186 nodes · 327 edges · 12 communities
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 46 edges (avg confidence: 0.74)
...
Cohesion: 0.10
Nodes (21): 1x2 Bookmaker Odds Formulation, Premier League Match Outcome ML Pipeline, Multiplicative Odds Conversion, Odds-Only-Equal-Profitability-Confidence (OO-EPC), Power Odds Conversion, Shin Odds Conversion, Sports Betting Actuarial Literature Corpus Index, solve_shin_probabilities (+13 more)

### Community 4 - "赛前 3 道金刚硬红线"
Cohesion: 0.18
Nodes (12): 2026-09-06 赛前精算预测, 2026-09-06 赛后全景复盘报告, 平局精算推演六维加权决策模型 (100分制), 2026-09-07 赛前精算预测, 2026-09-07 赛后全量复盘报告 (3.0模型确立), 2026-09-08 赛前精算推演报告, 总准确率与战绩实时看板, 四大安全断路器 (+4 more)
...
## Knowledge Gaps
- **38 isolated node(s):** `Threshold Optimization Discrepancy (ROI vs Profit)`, `2008 散户情绪与庄家定价偏见`, `Profitability Betting Strategies A and B`, `Shin's Odds Normalization Method`, `Ten Tactical Play Styles Framework` (+33 more)
...
- **Why does `Odds-Only-Equal-Profitability-Confidence (OO-EPC)` connect `Odds-Only-Equal-Profitability-Confidence (OO-EPC)` to `赔率数值`?**
